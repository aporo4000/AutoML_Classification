...
def predict(
    project_id, compute_region, model_id, file_path, user_folder, score_threshold=""
):
    ...
    # print("model_full_id:", model_full_id)
    ...
    if response != '':
        output = {"Classification result": {"Predicted class name": result.display_name, "Predicted class score": result.classification.score}, "img_name":{"image_path": file_path}}
        with open(user_folder+'/predict_output.json', "w") as f:
            f.write('[\n')
