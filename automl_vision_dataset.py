...
def create_dataset(project_id, compute_region, dataset_name, user_folder, multilabel=False):
    """Create a dataset."""
    ...
    ### project_id_file = os.environ['USER_NAME'] + '/dataset_id_' + project_id + '.txt'
    project_id_file = user_folder + '/dataset_id_' + project_id + '.txt'
...
def import_data(project_id, compute_region, dataset_id, path):
    ...
    print("dataset_full_id :", dataset_full_id)
    # Get the multiple Google Cloud Storage URIs.
    input_uris = path.split(",")
    print("input_uris:", input_uris)
...
if __name__ == "__main__":
    ...
    print("compute_region :", compute_region)
    print("args :", args)
    if args.command == "create_dataset":
        ...
        print("args.u: ", args.u)
        create_dataset(
            project_id, compute_region, args.dataset_name, args.u, multilabel
        )
